...
import AdvancedWebPenetrationTesting from "./pages/AdvancedWebPenetrationTesting";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/advanced-web-penetration-testing" element={<AdvancedWebPenetrationTesting />} />
